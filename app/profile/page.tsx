...
import { Music, ArrowLeft, Settings, Edit, Users, Heart, Play } from 'lucide-react'
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-300 mb-4">Producer & Beat Maker | Creating vibes since 2020</p>
                
                <div className="flex justify-center md:justify-start space-x-8 mb-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white">{userStats.tracks}</div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white">{userStats.likes.toLocaleString()}</div>
        ...
        <Tabs defaultValue="tracks" className="space-y-6">
          <TabsList className="bg-white/10 border-white/20">
            <TabsTrigger value="tracks" className="data-[state=active]:bg-white/20">My Tracks</TabsTrigger>
            <TabsTrigger value="liked" className="data-[state=active]:bg-white/20">Liked</TabsTrigger>
            <TabsTrigger value="collaborations" className="data-[state=active]:bg-white/20">Collaborations</TabsTrigger>
          </TabsList>

          <TabsContent value="tracks" className="space-y-4">
            {recentTracks.map((track) => (
              <Card key={track.id} className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <Button size="sm" className="rounded-full w-10 h-10 bg-gradient-to-r from-pink-500 to-purple-600">
          ...
          <TabsContent value="collaborations">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-400">Your collaborations will appear here</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
