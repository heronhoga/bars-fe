...
import { RegisterFormData, FormErrors } from "@/types/registerType";
...
export default function RegisterPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.discord && !/^[a-zA-Z0-9._]{1,32}$/.test(formData.discord)) {
      newErrors.discord =
        "Discord username should be 1-32 characters and contain only letters, numbers, dots, and underscores";
    }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">
            Join the music collaboration community
          </p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {errors.region && (
                  <p className="text-pink-400 text-sm">{errors.region}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                {errors.discord && (
                  <p className="text-pink-400 text-sm">{errors.discord}</p>
                )}
